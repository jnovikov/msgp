...
func generate(f *parse.FileSet, mode gen.Method) (*bytes.Buffer, *bytes.Buffer, error) {
	...
	myImports := []string{"github.com/jnovikov/msgp/msgp"}
	...
	if mode&gen.Test == gen.Test {
		...
		if mode&(gen.Encode|gen.Decode) != 0 {
			writeImportHeader(testbuf, "bytes", "github.com/jnovikov/msgp/msgp", "testing")
		} else {
			writeImportHeader(testbuf, "github.com/jnovikov/msgp/msgp", "testing")
		}
		testwr = testbuf
	}
...
func writePkgHeader(b *bytes.Buffer, name string) {
	...
	// https://github.com/jnovikov/msgp/issues/229
	// https://golang.org/s/generatedcode
	b.WriteString("// Code generated by github.com/jnovikov/msgp DO NOT EDIT.\n\n")
}
