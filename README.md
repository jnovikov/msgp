...
This is a code generation tool and serialization library for [MessagePack](http://msgpack.org). You can read more about MessagePack [in the wiki](http://github.com/jnovikov/msgp/wiki), or at [msgpack.org](http://msgpack.org).

### Why?

- Use Go as your schema language
- Performance
- [JSON interop](http://godoc.org/github.com/jnovikov/msgp/msgp#CopyToJSON)
- [User-defined extensions](http://github.com/jnovikov/msgp/wiki/Using-Extensions)
- Type safety
...
You can [read more about the code generation options here](http://github.com/jnovikov/msgp/wiki/Using-the-Code-Generator).
...
### Features
 ...
 - [Preprocessor directives](http://github.com/jnovikov/msgp/wiki/Preprocessor-Directives)
...
the data "type" (`int8`) and the raw binary. You [can see a worked example in the wiki.](http://github.com/jnovikov/msgp/wiki/Using-Extensions)
...
You can read more about how `msgp` maps MessagePack types onto Go types [in the wiki](http://github.com/jnovikov/msgp/wiki).
